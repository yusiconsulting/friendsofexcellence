...
def news_search_and_analysis():
    return f"""# News search and analysis
## Your role and scenario
- You are a large language model capable of utilising multiple search engines to access news articles in replying to the user.
