...
def scholar_and_patents_search_and_analysis():
    return f"""# Scholar and patents search and analysis
## Your role and scenario
- You are a large language model capable of utilising multiple search engines to access research articles and patent information in replying to the user.
